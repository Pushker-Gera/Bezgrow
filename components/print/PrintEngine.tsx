...
function PrintEngineStyles() {
  return (
    <style jsx global>{`
      ...
      html[data-print-format="thermal"] @page { size: 80mm auto; margin: 2mm; }
      ...
      .preview-scroll { height: 100dvh; overflow: auto; padding: 32px; display: flex; justify-content: center; align-items: flex-start; }
      ...
      .print-a4 { width: 210mm; min-height: 297mm; padding: 13mm; }
      .print-half-compact { width: 148mm; height: 210mm; padding: 7mm; }
      .print-half-top { width: 210mm; height: 297mm; padding: 8mm; }
      .top-half-content { height: 140mm; overflow: hidden; border: 1px solid #0f172a; padding: 5mm; }
      .manual-notes-space { height: 132mm; border: 1px dashed #94a3b8; border-top: 0; display: flex; align-items: flex-start; color: #94a3b8; padding: 8mm; font-size: 12px; }
      .print-thermal { width: 80mm; min-height: 160mm; padding: 3mm; font-family: "Courier New", monospace; box-shadow: 0 20px 70px rgba(0,0,0,.28); }
      .thermal-58 { width: 58mm; }
      .thermal-auto { width: 80mm; }
      ...
      .brand-block h1 { margin: 3px 0; font-size: 24px; line-height: 1; font-weight: 900; }
      ...
      .item-table { width: 100%; margin-top: 9px; border-collapse: collapse; table-layout: auto; }
      .item-table thead { display: table-header-group; }
      .item-table th { position: sticky; top: 0; background: #0f172a; color: #fff; font-size: 7px; letter-spacing: .08em; text-transform: uppercase; padding: 5px 4px; text-align: left; }
      .item-table td { border: 1px solid #e2e8f0; padding: 5px 4px; font-size: 8px; vertical-align: top; }
      .item-table .wrap { max-width: 180px; white-space: normal; word-break: break-word; }
      .item-table .wrap span { display: block; color: #64748b; font-weight: 400; }
      .item-table.compact th, .item-table.compact td { padding: 3px; font-size: 6.8px; }
      ...
      .footer-row { display: flex; justify-content: space-between; gap: 12px; align-items: flex-end; margin-top: 9px; }
      .codes-block { display: flex; gap: 10px; align-items: center; }
      ...
      .margin-compact .print-a4 { padding: 9mm; }
      .margin-wide .print-a4 { padding: 17mm; }
      ...
      .print-thermal h1 { margin: 0 0 4px; font-size: 15px; }
      .print-thermal p, .print-thermal td, .print-thermal th, .print-thermal span, .print-thermal strong { font-size: 9px; line-height: 1.25; }
      .thermal-rule { border-top: 1px dashed #000; margin: 7px 0; }
      ...
      .thermal-table th, .thermal-table td { border-bottom: 1px dotted #999; padding: 3px 0; text-align: left; }
      .thermal-total { border-top: 1px solid #000; margin-top: 6px; padding-top: 6px; font-size: 12px; font-weight: 900; }
      ...
      @media print {
        ...
        .enterprise-print-shell, .print-preview-stage, .preview-scroll, .print-document { display: block !important; height: auto !important; overflow: visible !important; padding: 0 !important; margin: 0 !important; background: #fff !important; transform: none !important; }
        .invoice-paper { box-shadow: none !important; margin: 0 auto !important; break-inside: avoid; }
        html[data-print-format="thermal"] .invoice-paper { margin: 0 !important; }
      }
    `}</style>
  )
}

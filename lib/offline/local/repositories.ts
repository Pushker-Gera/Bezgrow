...
function invoiceRow(input: DataRow, organizationId: string, index = 0) {
  ...
  return {
    ...
    taxable_minor: number(input, ["taxable_minor"], Math.round(number(input, ["taxable_amount"], 0) * 100)),
    cgst_minor: number(input, ["cgst_minor"], Math.round(number(input, ["cgst_amount"], 0) * 100)),
    sgst_minor: number(input, ["sgst_minor"], Math.round(number(input, ["sgst_amount"], 0) * 100)),
    igst_minor: number(input, ["igst_minor"], Math.round(number(input, ["igst_amount"], 0) * 100)),
    cess_minor: number(input, ["cess_minor"], Math.round(number(input, ["cess_amount"], 0) * 100)),
    grand_total_minor: number(input, ["grand_total_minor"], Math.round(amount * 100)),
    paid_minor: number(input, ["paid_minor"], Math.round(number(input, ["paid_amount"], 0) * 100)),
    outstanding_minor: number(input, ["outstanding_minor"], Math.round(number(input, ["outstanding_amount"], 0) * 100)),
    place_of_supply: text(input, ["place_of_supply"]),
    customer_gstin: text(input, ["customer_gstin"]),
    supply_type: text(input, ["supply_type"]),
    transaction_type: text(input, ["transaction_type"]),
    tax_category: text(input, ["tax_category"], "TAXABLE"),
  }
}
...
function invoiceItemRow(input: DataRow, organizationId: string, index = 0) {
  return {
    ...
    taxable_minor: number(input, ["taxable_minor"], 0),
    cgst_minor: number(input, ["cgst_minor"], Math.round(number(input, ["cgst_amount"], 0) * 100)),
    sgst_minor: number(input, ["sgst_minor"], Math.round(number(input, ["sgst_amount"], 0) * 100)),
    igst_minor: number(input, ["igst_minor"], Math.round(number(input, ["igst_amount"], 0) * 100)),
    cess_minor: number(input, ["cess_minor"], Math.round(number(input, ["cess_amount"], 0) * 100)),
    gst_rate_basis_points: number(input, ["gst_rate_basis_points"], Math.round(number(input, ["tax_percent", "gst"], 0) * 100)),
  }
}

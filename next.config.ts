  ...
  async headers() {
    return [
      ...
      ...[
        ...
        "/downloads/Bezgrow-mac.dmg.release.json",
        "/downloads/Bezgrow-windows.exe.release.json",
        "/downloads/Bezgrow-windows.msi.release.json",
        "/downloads/Bezgrow-windows.msix.release.json",
      ].map((source) => ({
        source,
        headers: [

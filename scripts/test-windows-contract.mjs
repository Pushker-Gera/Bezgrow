...
assert.match(rust, /var_os\("APPDATA"\)[\s\S]*WINDOWS_APP_DATA_DIR/, "Windows data must resolve from %APPDATA%\\Bezgrow.")
...
assert.match(workflow, /aarch64-pc-windows-msvc/, "Windows ARM64 release target is missing.")

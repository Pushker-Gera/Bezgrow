...
assert.match(rust, /cfg\(target_os = "windows"\)[\s\S]*windows_hidden_command\("rundll32\.exe"\)[\s\S]*FileProtocolHandler/, "Windows must open the validated PDF through the registered OS application without a console.")

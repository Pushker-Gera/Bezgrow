...
assert.equal(normalizeWhatsAppPhone("91+9876543210"), "")
assert.equal(normalizeWhatsAppPhone("++44 7700 900123"), "")
...
const whatsAppInvoice = fixture(2)
const whatsAppMessage = createProfessionalInvoiceMessage(whatsAppInvoice)
assert.equal(whatsAppMessage, `Hello E2E-OFFLINE-FINAL-Customer,

Thank you for choosing E2E-OFFLINE-FINAL-Business.
...
Thank you.
E2E-OFFLINE-FINAL-Business

Generated by Bezgrow`)
const whatsAppUrl = createWhatsAppInvoiceUrl(whatsAppInvoice)
assert.match(whatsAppUrl, /^https:\/\/wa\.me\/919876543210\?text=/)
assert.equal(new URL(whatsAppUrl).searchParams.get("text"), whatsAppMessage)

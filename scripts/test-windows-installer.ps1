...
Invoke-AppLaunchCycle 2 -LaunchPath $startMenuShortcut -ExpectedSchema 22
Invoke-InstalledSqliteCrud "verify" "22"

try {
  Enable-BezgrowOfflineMode
  Invoke-AppLaunchCycle 3 -ExpectedSchema 22
  Invoke-InstalledSqliteCrud "verify" "22"
} finally {
  Remove-BezgrowOfflineRules
}
...
Invoke-AppLaunchCycle 4 -LaunchPath $desktopShortcut -ExpectedSchema 22
Invoke-InstalledSqliteCrud "verify" "22"

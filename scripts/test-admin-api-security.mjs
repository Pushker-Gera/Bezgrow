...
assert.match(readiness, /2026082401/, "Schema readiness must require the current application-facing control-plane contract.")
assert.match(readiness, /expectedVersion >= ADMIN_CONTROL_PLANE_SCHEMA_VERSION/, "Readiness must reject older contracts while accepting additive, backward-compatible schema repairs.")

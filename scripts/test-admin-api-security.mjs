...
assert.match(readiness, /2026082201/, "Schema readiness must require every current control-plane migration.")
...
assert.match(licenseRoute, /\.rpc\("admin_mutate_license"/, "Licence changes must cross the atomic server-side mutation boundary.")
